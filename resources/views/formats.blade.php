    ...
    <div class="p-2">
        ...
        <main class="flex flex-wrap items-center justify-center p-4 bg-blanco">
            ...
            <div class="flex flex-col items-start bg-white rounded overflow-hidden shadow-md mb-4 mr-6">
                <img class="h-52 object-cover" src="{{ asset('assets/img/Formato-PPTX.png') }}" alt="folleto"
                    width="160px">
                <div class="font-bold text-sm m-2 text-gray-600 font-gotham whitespace-pre-line">Título del formato xxx
                    xxxxxxxxxxxxxxxxxx</div>
                <button
            ...
            <div class="flex flex-col items-start bg-white rounded overflow-hidden shadow-md mb-4 mr-6">
                <img class="h-52 object-cover" src="{{ asset('assets/img/Formato-XLSX.png') }}" alt="folleto"
                    width="160px">
                <div class="font-bold text-sm m-2 text-gray-600 font-gotham whitespace-pre-line">Título del formato xxx
                    xxxxxxxxxxxxxxxxxx</div>
                <button
            ...
            <div class="flex flex-col items-center justify-center bg-white rounded overflow-hidden shadow-md mb-4 mr-6">
                <img class="h-52 object-cover" src="{{ asset('assets/img/Formato-DOCX.png') }}" alt="folleto"
                    width="160px">
                <div class="font-bold text-sm m-2 text-gray-600 font-gotham whitespace-pre-line">Título del formato xxx
                    xxxxxxxxxxxxxxxxxx</div>
                <button
